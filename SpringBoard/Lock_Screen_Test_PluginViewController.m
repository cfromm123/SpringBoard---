...
// Header File
#import "Lock_Screen_Test_PluginViewController.h"

@interface Lock_Screen_Test_PluginViewController ()


@end

@implementation Lock_Screen_Test_PluginViewController
...
- (id)initWithCoder:(NSCoder *)aDecoder {
	...
	if (self) {
		...
		self.title = @"Lock Screen Test Plugin";
