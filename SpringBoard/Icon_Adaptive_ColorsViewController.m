...
// Header File
#import "Icon_Adaptive_ColorsViewController.h"

@interface Icon_Adaptive_ColorsViewController ()


@end

@implementation Icon_Adaptive_ColorsViewController
...
- (id)initWithCoder:(NSCoder *)aDecoder {
	...
	if (self) {
		...
		self.title = @"Icon Adaptive Colors";
