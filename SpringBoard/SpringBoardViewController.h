...
@property (weak, nonatomic) IBOutlet UIView *rectangleView2;
@property (weak, nonatomic) IBOutlet UIView *rectangleView4;
@property (weak, nonatomic) IBOutlet UITableView *tableView1;
@property (weak, nonatomic) IBOutlet UIView *rectangleView1;
@property (weak, nonatomic) IBOutlet UIView *rectangleView3;
@end
