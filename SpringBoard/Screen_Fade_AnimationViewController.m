...
// Header File
#import "Screen_Fade_AnimationViewController.h"

@interface Screen_Fade_AnimationViewController ()


@end

@implementation Screen_Fade_AnimationViewController
...
- (id)initWithCoder:(NSCoder *)aDecoder {
	...
	if (self) {
		...
		self.title = @"Screen Fade Animation";
